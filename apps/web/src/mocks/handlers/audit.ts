...
const EVENT_TYPE_FROM_ACTION: Record<string, string> = {
  ...
  ACK2_RECEIVED:               'checklist-completed',
  SUBMISSION_TRANSMITTED:      'checklist-completed',
  ...
  FRAMEWORK_ALERT_TRIGGERED:   'checklist-completed',
  STAGE_ADVANCED:              'checklist-completed',
