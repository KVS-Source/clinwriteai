...
- Master Library pull bypasses the source currency check (FR-E-005) — Master Library cards are by definition current (they were just approved and pushed)
...
Per PRD v4.1 §19.2 Stage 4 (Medical Affairs approval is part of Stage 4 but begins as a review step):
...
| Task | Ideation Lead | KOL | MA Lead | MA Member | Creative | Cal Manager |
|------|--------------|-----|---------|-----------|----------|-------------|
| Upload artefact & tag sections | **R/A** | I | I | I | I | I |
| Record voice notes | C | I | I | I | I | I |
| AI atomisation & compliance screen | **R** | I | C | I | I | I |
| KOL review & approval | I | **R/A** | C | I | I | I |
| Medical Affairs review | C | I | **R/A** | C | I | I |
| Schedule content on calendar | C | I | C | I | I | **R/A** |
| Execute publishing | I | I | I | C | **R** | A |
| Post-publish monitoring | C | I | **A** | C | R | C |
...
- All PDF outputs from Module E (long-form articles, HCP summaries) must pass WCAG 2.2 Level AA accessibility checks before publishing
- Uses the same WCAG checking engine as Module C FR-C-022
...
- 21 CFR Part 11 audit trail (cross-platform): every ideation stage transition, approval, scheduling, and publishing event is logged.
...
- WCAG 2.2 Level AA: all Module E digital outputs (PDF, HTML) must pass (implemented via FR-E-019 using Module C WCAG engine).
...
| `ideation_content_card` | id, ideation_artefact_id, source_section, source_passage, claim_currency_status, channel_formats (JSONB array), kol_status (pending/approved/rejected), ma_status (pending/approved/rejected), provenance (JSONB — source doc, section, passage, approval_date) | Core content unit |
...
|-----------|--------|---------|-------------------|
| WCAG 2.2 / Section 508 | W3C / US Congress | 2023 / Current | Mandatory — all Module E digital outputs (PDF, HTML articles) must pass Level AA |
...
Per PRD v4.1 §19.5, the complete notification spec:
